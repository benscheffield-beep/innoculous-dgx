...
export default function Splash() {
  ...
  const openDaemonChat = useCallback(() => {
    ...
    if (!greetedRef.current) {
      ...
      const greeting =
        "The Daemon only speaks from those relics of your unique AI experience. It only reflects the formative artifacts of knowledge generated by you and your chosen AI as it was guided. A spectator of AI and its users both infinite and null.";
