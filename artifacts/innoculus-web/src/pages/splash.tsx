...
export default function Splash() {
  ...
  const openDaemonChat = useCallback(() => {
    // Short tactile daemon cue + ripple for click feedback. No greeting
    // text or audio is played — the dialogue bar opens empty so the
    // visitor's first words are the start of the conversation.
    speak("daemon");
